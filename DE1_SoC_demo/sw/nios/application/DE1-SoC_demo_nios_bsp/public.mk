...
SOPCINFO_FILE := C:/repos/quartus_proj/BM-CycloneV-DE1_SoC/DE1_SoC_demo/hw/quartus/soc_system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001028
SOPC_SYSID_FLAG += --sidp=0x8001028
ELF_PATCH_FLAG  += --sidp 0x8001028

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1709099101
SOPC_SYSID_FLAG += --timestamp=1709099101
ELF_PATCH_FLAG  += --timestamp 1709099101
