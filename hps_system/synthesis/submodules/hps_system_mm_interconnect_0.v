// hps_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module hps_system_mm_interconnect_0 (
		...
		input  wire        keys_reset_reset_bridge_in_reset_reset, // keys_reset_reset_bridge_in_reset.reset
	...
	wire          keys_s1_agent_rp_valid;                                   // keys_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] keys_s1_agent_rp_data;                                    // keys_s1_agent:rp_data -> router_003:sink_data
	wire          keys_s1_agent_rp_ready;                                   // router_003:sink_ready -> keys_s1_agent:rp_ready
	wire          keys_s1_agent_rp_startofpacket;                           // keys_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          keys_s1_agent_rp_endofpacket;                             // keys_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> keys_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> keys_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // keys_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> keys_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> keys_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> keys_s1_burst_adapter:sink0_endofpacket
	wire          keys_s1_burst_adapter_source0_valid;                      // keys_s1_burst_adapter:source0_valid -> keys_s1_agent:cp_valid
	wire  [111:0] keys_s1_burst_adapter_source0_data;                       // keys_s1_burst_adapter:source0_data -> keys_s1_agent:cp_data
	wire          keys_s1_burst_adapter_source0_ready;                      // keys_s1_agent:cp_ready -> keys_s1_burst_adapter:source0_ready
	wire    [1:0] keys_s1_burst_adapter_source0_channel;                    // keys_s1_burst_adapter:source0_channel -> keys_s1_agent:cp_channel
	...
	wire          keys_s1_agent_rdata_fifo_out_valid;                       // keys_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] keys_s1_agent_rdata_fifo_out_data;                        // keys_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          keys_s1_agent_rdata_fifo_out_ready;                       // avalon_st_adapter_001:in_0_ready -> keys_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                          //                      clk.clk
		.reset                  (keys_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~leds_reset_reset_bridge_in_reset_reset),                  //        clk_reset.reset_n
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                               //             clk.clk
		.reset                   (keys_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	hps_system_mm_interconnect_0_router router (
	...
	hps_system_mm_interconnect_0_router router_001 (
	...
	hps_system_mm_interconnect_0_router_002 router_002 (
	...
	hps_system_mm_interconnect_0_router_002 router_003 (
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (clk_0_clk_clk),                               //       cr0.clk
		.reset                 (keys_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	hps_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                            //        clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset),                   //  clk_reset.reset
	...
	hps_system_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                            //        clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset),                   //  clk_reset.reset
	...
	hps_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (keys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_system_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hps_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	hps_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (keys_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
